						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<div class="">
									...
									<div class="col-sm-3">
										<a type="button" href="#" class="btn btn-sm btn-default cart adopsi" id="<?php echo $n['id_hewan'];?>">Adopsi</a>
									</div>
								</div>
					...
					<div class="category-tab shop-details-tab"><!--category-tab-->
						<div class="col-sm-12">
							<ul class="nav nav-tabs">
								<li class="active"><a href="index.php?a=detail&hewan=<?php echo $n['id_hewan'];?>&ras=<?php echo $n['ras'];?>&jenis=<?php echo $n['jenis_hewan']; ?>">Artikel</a></li>
								<li><a href="index.php?a=detail-rawat-aku&hewan=<?php echo $n['id_hewan'];?>&ras=<?php echo $n['ras'];?>&jenis=<?php echo $n['jenis_hewan']; ?>">Rawat aku</a></li>
							</ul>
						</div>
